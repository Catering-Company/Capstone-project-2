...
# Headers for the min/max functions are also included.
...
# Asks the user what their preferred currency is by requesting them to enter either 'us dollars' or 'pounds sterling'.
# If the user enters anything else then what_currency returns "incorrect-usage".
# A while-loop in main(config) will then re-prompt the user until they enter either 'us dollars' or 'pounds sterling'.
...
# option_chooser, just as in main_menu.py.
# If the user enters anything other than 1 through to 4, then they will be re-prompted. 

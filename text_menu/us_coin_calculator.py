...
# Gets the coin-denomination that the user wants to turn their cents into. If the user
...
# the number of said coins you can recieve in exchange for your cents, along
# with the amount of cents you will have left. 
